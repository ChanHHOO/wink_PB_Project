        ...
        <div>
            <Segment className="ui inverted segment">
                    <Menu className="ui inverted pointing secondary menu">
                        <Menu.Item className="active item" stateName = 'Main' onClick="setState('Main');">Main</Menu.Item>
                        <Menu.Item className="item" stateName = 'MyBlog' onClick={() => setState('MyBlog')}>MyBlog</Menu.Item>
